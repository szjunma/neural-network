...
ggplot(data) + geom_point(aes(x=x, y=y, color = as.character(label)), size = 2) + theme_tws(base_size = 15) +
  xlab('X') + ylab('Y')+ xlim(x_min, x_max) + ylim(y_min, y_max) +
  title_with_subtitle('Spiral Data Visulization', 'consists of 4 classes') +
  scale_color_discrete(name = 'Label') + coord_fixed(ratio = 0.6) +
  theme(axis.ticks=element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        axis.text=element_blank(),legend.position = c(0.85, 0.8))
```
...
ggplot()+
  ...
  geom_point(data = data, aes(x=x, y=y, color = as.character(label)), size = 2) + theme_tws(base_size = 15) +
  xlab('X') + ylab('Y') + title_with_subtitle('Neural Network Decision Boundary', '50 neurons') +
  scale_color_discrete(name = 'Label') + coord_fixed(ratio = 0.6) +
  theme(axis.ticks=element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        axis.text=element_blank(),legend.position = c(0.85, 0.8))
```
